 ...
 * <p>
 * curl -X GET 'https://api.browseract.com/v2/agent/list-tasks?page=1&size=10' -H 'Authorization: Bearer app-abcdefghijklmn'
 */
...
public class ListTasks {
    ...
    public static void main(String[] args) {
        ...
        // api address
        String url = "https://api.browseract.com/v2/agent/list-tasks?page=1&size=10";
