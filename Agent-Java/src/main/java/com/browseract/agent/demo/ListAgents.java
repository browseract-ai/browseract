...
public class ListAgents {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            URL url = new URL("https://api.browseract.com/v2/agent/list-agents?page=" + page + "&limit=" + limit);
            ...
            if (responseCode == 200) {
                ...
                try (BufferedReader br = new BufferedReader(new InputStreamReader(connection.getInputStream()))) {
                    ...
                    System.out.println("Total agents: " + totalCount + ", Current page agents: " + currentItems);
...
success example: 
{
  ...
  "items": [{
    ...
    "description": "An AI agent specialized in web scraping and data extraction tasks",
