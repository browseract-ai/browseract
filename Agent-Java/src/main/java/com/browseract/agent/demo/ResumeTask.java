 ...
 * This endpoint can only be used to resume tasks that were paused using the /pause-task endpoint.
 * <p>
 * Documentation:
...
public class ResumeTask {
    ...
    public static void main(String[] args) {
        ...
        // api address
        String url = "https://api.browseract.com/v2/agent/resume-task?task_id=" + taskId;
