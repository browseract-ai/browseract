...
/**
 * Description:
 * Get the current status of a workflow task. This is a lightweight endpoint that returns only the task status
...
public class GetTaskStatus {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            URL url = new URL("https://api.browseract.com/v2/workflow/get-task-status?task_id=" + taskId);
