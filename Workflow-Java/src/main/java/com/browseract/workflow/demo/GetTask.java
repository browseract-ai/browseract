...
/**
 * Description:
 * Retrieve detailed information about a specific task, including its current status, progress, and results.
 * <p>
 * Documentation:
...
public class GetTask {
    ...
    public static void main(String[] args) {
        ...
        // api address
        String url = "https://api.browseract.com/v2/workflow/get-task?task_id=" + taskId;
