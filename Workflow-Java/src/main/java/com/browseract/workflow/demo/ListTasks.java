...
public class ListTasks {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            URL url = new URL("https://api.browseract.com/v2/workflow/list-tasks?workflow_id=" + workflowId + "&page=" + page + "&limit=" + limit);
                ...
                try (BufferedReader br = new BufferedReader(new InputStreamReader(connection.getInputStream()))) {
                    ...
                    if (currentItems > 0) {
                        ...
                        for (JsonNode item : items) {
                            ...
                            System.out.println("Workflow ID: " + item.get("workflow_id").asText());
                            System.out.println("---");
                        }
                    }
                }
