...
/**
 * Description:
 * Retrieve a list of workflows associated with your account. This endpoint supports pagination and filtering.
 * <p>
 * Documentation:
 * https://www.browseract.com/reception/integrations/api-workflow
 * <p>
 * curl -X GET 'https://api.browseract.com/v2/workflow/list-workflows?page=1&size=10' -H 'Authorization: Bearer app-abcdefghijklmn'
 */
...
public class ListWorkflows {
    ...
    public static void main(String[] args) {
        ...
        // api address
        String url = "https://api.browseract.com/v2/workflow/list-workflows?page=1&size=10";
